package com.haswalk.solver.webserver;
...
public class WebServer {
    ...
    private void invoke(Socket socket) throws IOException {
        ...
        DataOutputStream outputToFile = new DataOutputStream(new FileOutputStream(new File(System.getProperty("user.dir") + "/src/resources/mesh.txt")));
